...
with open('create-filtered-vector-function.sql', 'r') as f:
    sql_function = f.read()

print("📝 Deploying find_similar_subject_lines_with_filters function...")
...
try:
    ...
    try:
        ...
        print("3. Copy and paste the contents of create-filtered-vector-function.sql")
